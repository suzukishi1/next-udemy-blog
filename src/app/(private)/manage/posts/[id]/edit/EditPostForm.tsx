...
export default function EditPostForm({ post }: EditPostFormProps) {
  ...
  return (
    <div className="container mx-auto mt-10">
      <h1 className="text-2xl font-bold mb-4">記事更新(Markdown対応)</h1>
      <form action={formAction} className="space-y-4">
        ...
        {preview && (
          // TailwindCSSがデフォルトのCSSをリセットするため、react-markdownで変換されたHTML要素のスタイルも消えてしまう
          // tailwindcss/typographyプラグイン を導入し cssクラス prose を適用する
          <div className="prose border p-4 bg-gray-50 max-w-none">
            <ReactMarkdown
